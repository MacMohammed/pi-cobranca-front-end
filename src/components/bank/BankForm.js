...
class BankForm extends HTMLElement {
  constructor() {
    ...
    this.shadowRoot.addEventListener("submit", (event) => {
      ...
      const form = this.shadowRoot.querySelector("#cadastro_banco");
      this.novoBanco(form);
    });
  }
  ...
  <div class="container">
      <form id="cadastro_banco">
          <div>
              <h1>Cadastro de Bancos</h1>
          </div>
          <ul class="flex-outer">
              <li>
                  <label for="codigo_febraban">Código Febran</label>
                  <input type="text" id="codigo_febraban" name="codigo_febraban" placeholder="Digite o código febraban do banco" required>
              </li>
              <li>
                  <label for="bankname">Nome do Banco</label>
                  <input type="text" id="bankname" name="bankname" placeholder="Digite o Nome do Banco" required>
              </li>
  ...
  novoBanco = async (form) => {
    const data = Object.fromEntries(new FormData(form));
    const url = urls.transacao.bancos;
    ...
    const options = {
      ...
      body: JSON.stringify({
        nome: data.bankname,
        codigo_febraban: parseInt(data.codigo_febraban),
      }),
    };
